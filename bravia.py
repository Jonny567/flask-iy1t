...
class TV:
    ...
    def back(self):
        self._send_irc_code('Back')
    def home(self):
        self._send_irc_code('Home')
    def help(self):
        self._send_irc_code('Help')
    def options(self):
        self._send_irc_code('Options')
    def exit(self):
        self._send_irc_code('Back')
    def menu(self):
        self._send_irc_code('SyncMenu')
    def display(self):
        self._send_irc_code('Display')
    def channelup(self):
        self._send_irc_code('ChannelUp')
    def channeldown(self):
        self._send_irc_code('ChannelDown')
    def up(self):
        self._send_irc_code('Up')
    def down(self):
        self._send_irc_code('Down')
    def left(self):
        self._send_irc_code('Left')
    def right(self):
        self._send_irc_code('Right')
    
    def one(self):
        self._send_irc_code('Num1')
    def two(self):
        self._send_irc_code('Num2')
    def three(self):
        self._send_irc_code('Num3')
    def four(self):
        self._send_irc_code('Num4')
    def five(self):
        self._send_irc_code('Num5')
    def six(self):
        self._send_irc_code('Num6')
    def seven(self):
        self._send_irc_code('Num7')
    def eight(self):
        self._send_irc_code('Num8')
    def nine(self):
        self._send_irc_code('Num9')
    def zero(self):
        self._send_irc_code('Num0')
    def f1(self):
        self._send_irc_code('Red')
    def f2(self):
        self._send_irc_code('Green')
    def f3(self):
        self._send_irc_code('Yellow')
    def f4(self):
        self._send_irc_code('Blue')
